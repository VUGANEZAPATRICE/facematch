...
logging.basicConfig(filename=os.path.join(log_dir, 'running_logs.log'), level=logging.INFO, format=logging_str,
                    filemode="a")
# filename = is where you want to save your file
# fie mode="a" means append

# file to generate pickle
...
# reading config file and artifacts
    artifacts = config['artifacts']
# reading keys inside artifacts.
